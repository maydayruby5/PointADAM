...
parser.add_argument('--exp_name', type=str, default='shape2model_DANN_0712',  help='Name of the experiment')
parser.add_argument('--out_path', type=str, default='./experiments', help='log folder path')
parser.add_argument('--dataroot', type=str, default='./data', metavar='N', help='data path')
parser.add_argument('--src_dataset', type=str, default='modelnet', choices=['scannet', 'c', 'scannet'])
parser.add_argument('--trgt_dataset', type=str, default='scannet', choices=['c', 'shapenet', 'scannet'])
...
for epoch in range(args.epochs):
    ...
    for data1, data2 in zip(src_train_loader, trgt_train_loader):
        ...
        if data2 is not None:
            ...
            trgt_print_losses['adv'] += adloss.item() * batch_size * 2  # 目标域的对抗损失
            trgt_print_losses['DefRec'] += defrec_loss.item() * batch_size * 2  # 目标域的def损失
            src_print_losses['total'] += defrec_loss.item() * batch_size * 2

            loss = defrec_loss+0.5*adloss
